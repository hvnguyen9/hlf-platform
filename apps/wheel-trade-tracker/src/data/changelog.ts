...
export const changelog: ChangelogEntry[] = [
  {
    ...
    version: "v2.20.0",
    highlights: [
      "New Cash Allocation card on the Overview splits your capital three ways instead of one lumped 'in use' number: Committed (cash already out — stock lots and LEAPs), Reserved (cash-secured put collateral that only deploys if you get assigned), and Free (truly unencumbered). A segmented bar shows the mix at a glance.",
      "New Assignment Ladder — a forward look at every open cash-secured put in order of expiration, showing how much cash each would deploy if assigned and your running free cash after each date. Puts currently in the money are flagged, and a warning appears if full assignment would outrun your liquid cash and need margin or a roll. Full view at /ladder.",
