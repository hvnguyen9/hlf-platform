...
export const changelog: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "New Assignment Ladder — a forward look at every open cash-secured put in order of expiration, showing how much cash each would deploy if assigned and your running free cash after each date. Puts currently in the money are flagged, and a warning appears if full assignment would outrun your liquid cash and need margin or a roll. It lives right inside the Cash Allocation card; if you have a lot of expirations it shows the soonest few and links out to the full ladder page. Opening the ladder from a portfolio (its allocation bar or the link) scopes the page to just that portfolio.",
