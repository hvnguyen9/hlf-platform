...
export const changelog: ChangelogEntry[] = [
  {
    ...
    version: "v2.20.0",
    highlights: [
      "New Cash Allocation card leads the Overview and splits your capital three ways instead of one lumped 'in use' number: Committed (cash already out — stock lots and LEAPs), Reserved (cash-secured put collateral that only deploys if you get assigned), and Free (truly unencumbered). A segmented bar shows the mix at a glance. The same meter, in compact form, now sits in the Positions tab header (replacing the old single deployed bar), and the older Cash Available / Deployed KPI tiles are gone since this covers them better.",
