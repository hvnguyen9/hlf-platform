...
const FEATURES = [
  { icon: TrendingUp, label: "Auto-import realized trading P&L" },
  { icon: FileText, label: "Track income & expenses by category" },
  { icon: ShieldCheck, label: "Live tax estimate with CA & federal rules" },
];
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div
        ...
        style={{ background: "linear-gradient(160deg, oklch(0.42 0.24 268), oklch(0.34 0.20 280) 60%, oklch(0.28 0.16 290))" }}
      >
        {/* Subtle grid texture */}
        <div
        ...
        <div className="relative flex items-center gap-3 z-10">
          ...
          <div>
            <p className="font-bold text-base leading-tight">HLF Bookkeeping</p>
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-white/70 leading-relaxed max-w-xs">
              Income, expenses, and trading P&L — all in one place, organized by tax year.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-2.5 mb-8 justify-center">
            ...
            <div>
              <p className="font-bold text-base text-foreground leading-tight">HLF Bookkeeping</p>
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-1.5">Sign in to your bookkeeping dashboard</p>
          </div>
